...
var p1_actions = {
	"p1_move_forward": "RunForward",
	"p1_move_left": "RunLeft",
	"p1_move_right": "RunRight",
	"p1_move_backward": "RunBackward"
}
...
func _handle_p1_movement():
	...
	for action in p1_actions.keys():
		if Input.is_action_pressed(action):
			animation_to_play = p1_actions[action]
			break
